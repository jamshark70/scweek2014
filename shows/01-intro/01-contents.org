...
**** Almost all UGens have \ci{mul} and \ci{add} arguments.
     - @@latex:\cd{SinOsc.ar(440, 0, 100, 440)} $\to$ \cd{SinOsc.ar(440, 0) * 100 + 440}.@@
...
**** Earlier, we used \ci{+} to modulate frequency.
     ...
     - With $f=2000$ and $d=1000$, \gls{linear} modulation goes
       between 1000 and 3000 Hz: 12 semitones below and 7 above.
     - To go 7 semitones above and below, the lower frequency should
       be 1500 Hz. $1500 = \frac{2000}{1.5}$; $3000 = 2000 \cdot 1.5$.
...
**** /Reason/ about the UGen ranges.
     - The range I've got: $-1$ to $1$.
     - The range I need is \egls{exponential}: Use \mth{exprange}.
