...
*** Explanation of "canonical" style
...
*** Let's make some noise!
   1. Boot the audio server: \ks{Ctrl-B}.\\<all>
      See also /Language/ menu and server status.\\<all>
...
*** Modular approach
**** Instead, we'll start with a \egls{modular} approach.
     - Code blocks will be very small: 5--6 lines at most (at first).
     - Instead of one big \clss{SynthDef}, we will:
