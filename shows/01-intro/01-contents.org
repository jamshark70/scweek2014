...
**** Same pattern as before:
     ...
     - Use it in the filter (\cd{ffreq + \textasciitilde
...
**** Using \ci{+} for frequency is not quite right.
     - We hear frequency in terms of multiplication (an
       \egls{exponential} scale), not addition (\egls{linear} scale).
     - Using \ci{+}, the center frequency is in the middle, but the
       center /pitch/ is higher.
     - We should use \ci{*} to make the center frequency sound like
       the middle.
#+latex: \glsadd{cpsmidi}\glsadd{round}\glsadd{differentiate}
#+name: expscale
...
// 1000-2000 is an octave; 2000-3000 is a P5

[2000 / 1.5, 2000, 2000 * 1.5].cpsmidi.differentiate.round(0.01);
// prints: [ 88.19, 7.02, 7.02 ]
// 1500-2000 is a P5; 2000-3000 is a P5
#+end_src

*** Converting the LFO to multiplication
...
#+latex: \glsadd{exprange}\glsadd{reciprocal}
#+name: explfo
