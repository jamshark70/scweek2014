...
#+attr_latex: :align |p{0.45\textwidth}|p{0.45\textwidth}| :placement [h]
| \ci{+} Addition                           | \ci{-} Subtraction               |
| \ci{*} Multiplication                     | \ci{/} Division                  |
| \ci{**} Power-of                          | \ci{\%} Remainder                |
...
*** TODO Exercises: Try other UGens
* Note control
...
**** A \clss{Routine}'s return value is \mth{yield}ed.
     ...
     - You can \mth{stop} a Routine without \ks{Ctrl-.}.
#+name: resched2
