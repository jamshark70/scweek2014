...
#+name: mthgloss01
#+call: makegloss01(tbl=mth01,glosstype="mth") :results value latex
#+results: mthgloss01
...
**** {1\textwidth}{3in}					      :B_overlayarea:
     ...
     #+end_center
***** A \te{\gls{function}} is a block of code in curly braces.
     - Functions can take information in through \te{\gls{arguments}}.
...
**** {1\textwidth}{3in}					      :B_overlayarea:
     ...
     #+end_center
***** A \te{\gls{variable}} holds an object.
...
***** O1							  :B_onlyenv:
      ...
      :BEAMER_act: 1
      :END:
****** A \te{\gls{class}} is an \te{object type}.
...
***** O2							  :B_onlyenv:
      ...
      :BEAMER_act: 2
      :END:
****** \ugen{SinOsc} is a \te{\gls{UGen}} (Unit Generator) class.
...
**** {1\textwidth}{3in}					      :B_overlayarea:
     ...
     #+end_center
***** A \te{\gls{method}} defines an action that an object can perform.
...
**** {1\textwidth}{3in}					      :B_overlayarea:
     ...
     #+end_center
***** \te{\Gls{arguments}} pass information into a method or function.
...
*** Writing ranges in SC
    - Long form: \clss{ControlSpec}(low, high, curve, step, default)
