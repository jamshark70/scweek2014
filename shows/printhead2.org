...
#+LATEX_HEADER: 	{morekeywords={nil,true,false,var,classvar,this,thisProcess,thisThread,arg,thisFunction,super,currentEnvironment,Pdelta,Plot,Object,DynKlank,Formant,Saw,Note,LFGauss,LFNoise2,Dust,Point,Feedback,Rect,ControlSpec,Window,Pn,NamedControl,Mix,QuadL,VarSaw,HPF,Pxrand,BufRateScale,Pseq,RLPF,LFPulse,EnvGen,Switch,AllpassL,Impulse,Pulse,File,SinOsc,Tdef,LinCongL,Env,Out,LFSaw,BPF,Balance2,DelayL,Integer,IdentitySet,Task,TExpRand,Routine,TdefAllGui,CombL,Event,GUI,LFTri,EZSlider,FormantTable,Set,Pdefn,LFNoise1,Slider,Buffer,Scale,WhiteNoise,Array,Osc,Pwhite,PlayBuf,GrainBuf,LPF,Synth,Line,Play,Platform,Pseries,LocalIn,SynthDef,Pbind,Pkey,PinkNoise,Klank,Prand,TempoClock,Color,TGrains,Lag,LFNoise0,Rest,Ringz,LocalOut,UGen,Pdict,Pexprand,ProxySpace,Button,Dictionary,Formlet,Pluck,Pan2},
