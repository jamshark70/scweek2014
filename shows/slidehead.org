...
#+LATEX_HEADER: 	{morekeywords={nil,true,false,var,classvar,this,thisProcess,thisThread,arg,thisFunction,super,currentEnvironment,Plot,Object,Pdefn,LFNoise1,Buffer,Scale,Osc,Saw,Note,Pwhite,LPF,PlayBuf,Synth,Line,LFGauss,LFNoise2,GrainBuf,Point,Play,Feedback,Platform,Mix,QuadL,VarSaw,HPF,BufRateScale,Pseq,SynthDef,Pbind,RLPF,LFPulse,Pkey,EnvGen,PinkNoise,Switch,Impulse,Prand,Pulse,TempoClock,SinOsc,Tdef,LinCongL,TGrains,Env,Out,LFSaw,BPF,Balance2,LFNoise0,Task,Routine,TdefAllGui,Pexprand,Event,ProxySpace,LFTri,Pan2},
